...
const about = require('./data/about')    //  Dynamic Data Json one
const hotelDetails = require('./data/eachExperience');


const pages = ['index','resorts', 'contact', 'dashboard', 'login'] // removed /hotels from here
...
router.get('/about', (req, res) => {    
  ...
  router.get('/experience/:slug', (req, res) => {
    ...
    const experience = hotelDetails[slug];
